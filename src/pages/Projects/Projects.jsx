        ...
        <div>
            <div className='projectColumn'>
                <div className='projectDiv'>
                    <img className='projectImage' src={GODSROULETTE} />
                    <h2>GOD'S ROULETTE | FREELANCE</h2>
                    <p className='projectDescription'>GOD'S ROULETTE is a game of 2 or 3 players in which roulette gambles are presented to the players and they must compete to see who finishes the game with a better balance of profits.</p>
                    <a className='projectLink' href='https://godsroulette.app/' target='_blank'>VIEW LIVE</a>
                </div>
                <div className='projectDiv'>
